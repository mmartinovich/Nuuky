            ...
            >
              ...
              <View style={styles.section}>
                ...
                {isRenaming ? (
                  ...
                  >
                    ...
                    {isCreator && <Ionicons name="pencil" size={18} color="rgba(255,255,255,0.3)" />}
                  </TouchableOpacity>
                )}
              </View>
              ...
              <View style={styles.section}>
                ...
                <View style={styles.actionsContainer}>
                  {/* Invite Friends */}
                  <TouchableOpacity style={styles.actionCard} onPress={onInviteFriends} activeOpacity={0.7}>
                    ...
                    >
                      <View style={[styles.actionIconContainer, { backgroundColor: accent.soft }]}>
                        {sharingLink ? (
                          ...
                          <Ionicons name="link-outline" size={20} color={accent.primary} />
                        )}
                      </View>
                      <View style={styles.actionTextContainer}>
